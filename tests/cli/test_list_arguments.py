...
def command_group(command_group: CommandGroup) -> None:
    ...
    def complex_test(
        ...
        Args:
            ...
            flags: The list of flags.
        """
        ctx.print(f"Strings: {strings}, Numbers: {numbers}, Flags: {flags}")
